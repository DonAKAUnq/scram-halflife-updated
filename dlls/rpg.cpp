...
int CRpg::GetItemInfo(ItemInfo *p)
{
	...
	p->pszAmmo1 = "rockets";
	//	p->iMaxAmmo1 = ROCKET_MAX_CARRY; // unq
	p->iMaxAmmo1 = gSkillData.ammoRocketMaxCarry; // unq
	p->pszAmmo2 = NULL;
	p->iMaxAmmo2 = -1;
...
class CRpgAmmo : public CBasePlayerAmmo
{
	...
	if ( g_pGameRules->IsMultiplayer() )
		...
		if (pOther->GiveAmmo(iGive, "rockets", gSkillData.ammoRocketMaxCarry) != -1) // unq replace ROCKET_MAX_CARRY
		{
